...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_personWithRemark_returnsPerson() throws Exception {
        Person personWithRemark = new PersonBuilder(BENSON).withRemark("Likes to swim.").build();
        JsonAdaptedPerson person = new JsonAdaptedPerson(personWithRemark);
        assertEquals(personWithRemark, person.toModelType());
    }
